...
insert into Comerciales values ('111','Pedro Alonso Jim�nez',1200.50,0,'1960/01/02');
insert into Comerciales values ('222','Julia P�rez Arribas',1305.75,1,'1971/11/12');
insert into Comerciales values ('333','Juan Lozano G�mez',1080.25,3,'1975/01/08');
insert into Comerciales values ('444','Sandra Molina S�nchez',1120.00,2,'1969/09/05');
insert into Comerciales values ('555','Salvador Beltr�n Jim�nez',975.50,0,'1980/11/10');
insert into Comerciales values ('666','Beatriz Mart�n Guti�rrez',1175.00,1,'1970/06/11');
insert into Comerciales values ('777','Eduardo Mart�nez Puig',1100.50,2,'1967/06/01');
insert into Comerciales values ('888','Juan Antonio Ochando Serrano',1000.50,0,'1982/03/03');
insert into Comerciales values ('999','Marina P�rez Blanco',1070.20,3,'1972/11/07');


insert into Productos values ('AC0001', 'Abrigo Caballero', 'Piel Color Marr�n',  120.50, 15);
insert into Productos values ('AS0001', 'Abrigo Se�ora', 'Piel Color Marr�n',  110.75, 25);
...
insert into Productos values ('AS0002', 'Abrigo Se�ora', 'Piel Color Negro',  120.75, 15);
insert into Productos values ('AS0003', 'Abrigo Se�ora', 'Ante  Color Marr�n',  90.95, 35);
insert into Productos values ('PS0001', 'Pantal�n Se�ora', 'Vaquero',  30.90, 30);
insert into Productos values ('PS0002', 'Pantal�n Se�ora', 'Lino',  39.90, 40);
...
GRANT ALL ON `ventas_comerciales`.*
TO `dwes`;